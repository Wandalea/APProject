...
3. Make sure you have Python 3 installed. You can check by going to the terminal or command line and typing
```sh
python  --version.
```
4. In the terminal or command line activate the virtual environment using
```sh
